...
const timelockDeployment = require(`../../deployments/${deploymentPath}/TimelockController.json`)
...
const { abi: timelockAbi, address: timelockContractAddress } = timelockDeployment
...
export const timelockContract = new ethers.Contract(timelockContractAddress, timelockAbi, signer)
